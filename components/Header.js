...
export default function Header() {
  return (
    <header className="flex justify-between items-center border-white/15 border border-solid rounded-[25px] text-white mt-6 ml-12 mr-12 h-16 backdrop-blur-lg bg-white/10 ">
